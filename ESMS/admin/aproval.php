...
<body>
	...
	<div class="row">
		 ...
		 if(isset($_REQUEST['assign']))
		{
        	...
        	if($result==TRUE){
        		$msg= "<div class='alert alert-success text-dark'>Assign Work</div>";
        	}
        	else{
        		$msg= "<div class='alert alert-warning'>Failed to assign</div";
        	}
		}
		...
		<div class=" col-sm-7 mt-5 ml-5 ">
			<div class="orderbox mt-5 border border-success  ml-5 pl-3 pr-3">
				...
				<div class="row">
					<div class="col-sm-8">
						 <label for="name">Name</label><br>
               			 <input type="text" name="name" class="form-control" value="<?php if(isset($_REQUEST['name'])) echo $_REQUEST['name']; ?>" >
					</div>
					<div class="col-sm-4">
				...
				<div class="row">
					<div class="col-sm-6">
						 <label for="type">Type</label><br>
               			 <input type="text" name="type" class="form-control" value="<?php if(isset($_REQUEST['type'])) echo $_REQUEST['type']; ?>">
					</div>
					<div class="col-sm-6">
                ...
                <input type="text" name="description" class="form-control" value="<?php if(isset($_REQUEST['description'])) echo $_REQUEST['description'];?>"><br>

                <div class="row">
                    <div class="col-sm-6">
                         <label for="address">Address</label><br>
                        <input type="text" name="address" class="form-control" value="<?php if(isset($_REQUEST['address'])) echo $_REQUEST['address'];?>">
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
               <a href="aproval.php" class="btn btn-outline-dark "><i class="pl-2 fas fa-arrow-left"></i>Refresh</a>
            </div>
            <?php $msg; ?>
        </div>
