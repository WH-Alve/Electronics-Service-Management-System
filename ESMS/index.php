	...
	<nav class="navbar navbar-expand-sm navbar-light shadow bg-light pl-5 fixed-top">
		...
		<div class="collapse navbar-collapse text-right pl-5" id="myMenu">
			<ul class="navbar-nav text-right" id="navtext">
				...
				<li class="nav-item p-2"><a href="admin/adminBoard.php" class="nav-link">Admin Page</a></li>
				<li class="nav-item p-2"><a href="technician.php" class="nav-link">Technician page</a></li>
	...
	<div class="container">
		...
		<div class="row mt-4 pt-3">
			<div class="col-lg-4">
				<div class="card">
					<div class="card-body text-center">
						<img src="img/shourav2.jpg" alt="Shourav">
			...
			<div class="col-lg-4">
				<div class="card">
					<div class="card-body text-center">
						...
						<img src="img/Meem.jpg" alt="Meem">
						<h4>Sumiya Haque Meem</h4>
						<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4">
				<div class="card">
					<div class="card-body text-center">
						<img src="img/alvi2.jpg" alt="alvi">
						<h4>Wasiul Hoqe Alve</h4>
						<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>
					</div>
				</div>
			</div>
